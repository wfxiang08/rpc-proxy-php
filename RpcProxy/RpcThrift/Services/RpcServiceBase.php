...
class RpcServiceBaseClient implements \RpcThrift\Services\RpcServiceBaseIf {
  ...
  public function send_ping() {
    ...
    if ($this->output_ instanceof TBinaryProtocol) {
      ...
      sm_thrift_protocol_write_binary($this->output_, 'ping', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
  }
  ...
  public function recv_ping() {
    if ($this->output_ instanceof TBinaryProtocol) {
      ...
      $result = sm_thrift_protocol_read_binary($this->input_, '\RpcThrift\Services\RpcServiceBase_ping_result', $this->input_->isStrictRead());
    }
    return;
  }
